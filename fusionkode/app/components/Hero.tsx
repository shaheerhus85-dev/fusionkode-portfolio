...
export default function Hero() {
    ...
    useGSAP(() => {
        ...
        // 2. Foreground Reveal (Mask Wipe + Letter Stagger)
    ...
    return (
        ...
        >
            {/* Layer 1: Background Marquee (Giant Word) */}
            <div className="absolute inset-0 flex items-center justify-center z-0 pointer-events-none overflow-hidden">
                ...
                >
                    <span
                        className="font-display font-black uppercase text-outline px-[5vw]"
                        style={{ fontSize: 'clamp(200px, 30vw, 600px)' }}
                    >
                        FUSIONKODE
                    </span>
                    <span
            ...
            <div className="relative z-10 w-full max-w-[1440px] px-8 md:px-16 flex flex-col items-center text-center">
                <div className="flex flex-col gap-4 md:gap-8">
                    <div ref={line1Ref} className="overflow-hidden">
                        <h2
                            className="font-mono uppercase tracking-[0.5em] text-white/60 mb-4"
                    ...
                    <div ref={line2Ref} className="overflow-hidden">
                        <h1
                            className="font-display font-bold uppercase text-white tracking-tighter leading-[0.85]"
                    ...
                    <div className="overflow-hidden max-w-2xl mx-auto">
                        <p className="font-sans text-white/40 md:text-xl leading-relaxed mt-4">
            ...
            {/* Bottom Layout Annotation */}
            <div className="absolute bottom-12 left-12 hidden lg:block font-mono text-[9px] uppercase tracking-[0.6em] text-white/10 [writing-mode:vertical-lr] rotate-180">
                SCROLL TO DEPLOY SYSTEM // STATUS: ACTIVE
            </div>
        </section>
    );
}
